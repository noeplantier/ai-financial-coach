...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/sign-in` | `/sign-in` | `/(auth)/sign-up` | `/sign-up` | `/(tabs)/coach` | `/coach` | `/(tabs)/dashboard` | `/dashboard` | `/(tabs)/profile` | `/profile` | `/(tabs)/transcations` | `/transcations` | `/auth/login`;
  // prettier-ignore
